...
public class XMLBeanDefinitionReaderTest {
    ...
    public void getBeanDefinitions() {
        BeanDefinitionReader reader = new XMLBeanDefinitionReader("configuration.xml");
        ...
        Assert.assertEquals("edu.eteslenko.JdbcUserDao",bean1.getClassName());
        Assert.assertEquals("userService",bean2.getId());
        Assert.assertEquals("edu.eteslenko.DefaultUserService",bean2.getClassName());
